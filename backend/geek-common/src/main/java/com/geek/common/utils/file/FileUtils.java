...
public class FileUtils {
    ...
    public static final long DEFAULT_MAX_SIZE = Long.valueOf(SpringUtils.getRequiredProperty("geek.fileMaxSize"))
            * 1024 * 1024;
    ...
    public static String writeImportBytes(byte[] data) throws IOException {
        return writeBytes(data, GeekConfig.getImportPath());
    }
    ...
    /**
     * 获取文件名称 /profile/upload/2022/04/16/geek.png -- geek.png
     *
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2022/04/16/geek.png -- geek
     *
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = GeekConfig.getProfile().length() + 1;
