...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='手机端用户表';

CREATE TABLE IF NOT EXISTS `free_query_point_record` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `free_user_id` bigint(20) NOT NULL COMMENT '手机端用户ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='手机端用户积分流水表';
...
SELECT 900100000204, '手机端用户管理', @mobile_menu_id, 3, 'freeUser', 'server/web/freeUser/index', '', 'freeQueryUser',
       1, 0, 'C', '0', '0', 'server:freeQueryUser:list', 'peoples', 'admin', NOW(), 'M10-手机端用户管理菜单'
WHERE NOT EXISTS (
  SELECT 1
  FROM `sys_menu`
...
SELECT 900100001721, '手机端用户查询', @free_user_menu_id, 1, '#', '', '', '', 1, 0, 'F', '0', '0', 'server:freeQueryUser:query', '#', 'admin', NOW(), 'M10-手机端用户查询按钮'
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT 900100001722, '手机端用户新增', @free_user_menu_id, 2, '#', '', '', '', 1, 0, 'F', '0', '0', 'server:freeQueryUser:add', '#', 'admin', NOW(), 'M10-手机端用户新增按钮'
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT 900100001723, '手机端用户修改', @free_user_menu_id, 3, '#', '', '', '', 1, 0, 'F', '0', '0', 'server:freeQueryUser:edit', '#', 'admin', NOW(), 'M10-手机端用户修改按钮'
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT 900100001724, '手机端用户删除', @free_user_menu_id, 4, '#', '', '', '', 1, 0, 'F', '0', '0', 'server:freeQueryUser:remove', '#', 'admin', NOW(), 'M10-手机端用户删除按钮'
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT 900100001725, '手机端用户积分调整', @free_user_menu_id, 5, '#', '', '', '', 1, 0, 'F', '0', '0', 'server:freeQueryUser:adjust', '#', 'admin', NOW(), 'M10-手机端用户积分调整按钮'
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`)
SELECT 900100001726, '手机端用户重置密码', @free_user_menu_id, 6, '#', '', '', '', 1, 0, 'F', '0', '0', 'server:freeQueryUser:resetPwd', '#', 'admin', NOW(), 'M10-手机端用户重置密码按钮'
