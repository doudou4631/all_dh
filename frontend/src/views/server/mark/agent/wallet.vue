  ...
  <div class="app-container">
    ...
    <el-card shadow="never" class="mt10">
      ...
      <el-table v-loading="loading" :data="logList">
        ...
        <el-table-column label="平台编码" prop="platformCode" min-width="130" show-overflow-tooltip />
...
<script setup name="MarkAgentWalletLog">
...
function getList() {
  loading.value = true
  listMarkAgentWalletLog(queryParams.value).then((res) => {
